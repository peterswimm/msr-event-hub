...
def get_chat_router():
    ...
    async def handle_card_action_unified(action_type: str, card_action: Dict[str, Any], context: Any):
        ...
        from api.actions.schemas import validate_action_payload
        from api.actions.middleware import ActionExecutionError, ActionValidationError
        ...
        try:
            ...
            # Build error card
            from api.actions.helpers import build_error_card
    ...
    async def welcome():
        ...
        from api.card_renderer import get_card_renderer
    ...
    async def stream_chat(payload: ChatRequest):
        ...
        try:
            ...
            from api.conversation_context import extract_context_from_messages
