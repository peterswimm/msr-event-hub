...
Include this import in your FastAPI app initialization:
    from api.actions import action_registry
"""
...
def initialize_action_handlers():
    ...
    try:
        from api.actions.browse import handlers as browse_handlers  # noqa: F401
        from api.actions.filter import handlers as filter_handlers  # noqa: F401
        from api.actions.search import handlers as search_handlers  # noqa: F401
        from api.actions.navigation import handlers as nav_handlers  # noqa: F401
