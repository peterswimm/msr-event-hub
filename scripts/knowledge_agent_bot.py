...
from src.core.schemas import BaseKnowledgeArtifact
        ...
        if enable_m365:
            try:
                if m365_connector is None:
                    from src.integrations.m365_connector import create_connector
...
if __name__ == "__main__":
    ...
    def run_sharepoint_pipeline_cli(cli_args: argparse.Namespace) -> None:
        ...
        from src.integrations.m365_connector import create_connector
        from src.integrations.m365_adapters import SharePointSource, SharePointSink, TeamsNotifier
    ...
    def run_onedrive_pipeline_cli(cli_args: argparse.Namespace) -> None:
        ...
        from src.integrations.m365_connector import create_connector
        from src.integrations.m365_adapters import OneDrivePathSource, OneDriveSink, TeamsNotifier
